...
C
C The DAE system is solved by DDASPK with a sparse approximate Jacobian
C matrix as the preconditioner for the preconditioned Krylov option of
C DDASPK.  The Jacobian is formed by using finite-differences of residual
...
C
C Set unit number for DDASPK error message output.
      CALL XSETUN(LOUT)
C
C Open output files.
